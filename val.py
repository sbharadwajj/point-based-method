...
data_list = ["106.dat", "22.dat", "269.dat", "370.dat", "429.dat", "555.dat", "670.dat", "750.dat", "9.dat"]
...
# for i, model in enumerate(model_list):
    ...
    np.savez('10imgs149.npz', predictions=pred.numpy(), data=partial.numpy(), gt=gt.numpy())
